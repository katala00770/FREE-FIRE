...
[FFD700]📌 INSTAGRAM : [00BFFF]@Hwk_pushpendra  
[FF1493]╚══════════════════════════╝""", idinv
                            )
                    )
                    senthi = False
...
[1E90FF][b][c]Telegram Name: teamxNoTmeowl[/b]
[1E90FF][c]@NoTmeowL60 [/c]

[FFD700][b][c]Developer: NoTmeowl[/b]
...
[FFD700]⚡ INSTAGRAM : [FFFFFF]@Hwk_pushpendra
...
#-------------------------------------------------------------#
                    if "1200" in data.hex()[0:4] and b"/help" in data:
                        try:
                            ...
                            clients.send(
                                self.GenResponsMsg(
                                        f"""[C][B][FFD700]═══⚓︎ NoTmeowl'S BOT | HELP 1/3 ⚓︎═══[00FF00][B]
[FFFFFF]⚡Add 100 Likes to Account:
[00FFFF]⚡/like [UID]
...
""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700]═══⚓︎ NoTmeowl'S BOT | HELP 2/3 ⚓︎═══[00FF00][B]
ec
[FFFFFF]⚡Create 5 Player Group 
[00FFFF]⚡/5
[FFFFFF]⚡Create 6 Player Group
[00FFFF]⚡/6
[FFFFFF]⚡Spam Invite Request 
[00FFFF]⚡/sm [uid]
[FFFFFF]⚡Attack Any Team
[00FFFF]⚡/attack [teamcode]
[FFFFFF]⚡Send Friend Request 
[00FFFF]⚡/spam [uid]
[00FFFF]━━━━━━━━━━━━
[00FF00] """, uid
                                    )
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700]═══⚓︎ NoTmeowl'S BOT | HELP 3/3 ⚓︎═══[00FF00][B]

[FFFFFF]⚡Play emote without emote id 
[00FFFF]⚡/play [uid] [1-400]
[FFFFFF]⚡ Play Max Evo Gun Emote
[00FFFF]⚡/ev [uid] [1-17]
[FFFFFF]⚡ Play Emote with emote id
[00FFFF]⚡/em [uid] [emote id]
[FFFFFF]⚡ Spam Play Emote 
[00FFFF]⚡/nm [uid] [Emote]
